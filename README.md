...
### Enviroment
.env: PRODUCTION ENVIROMENT FILE </br>
.env.development: DEVELOPEMTN ENVIROMENT FILE

```MONGODB_WRITE_CONNECTION_STRING
```REDIS_HOST=localhost //dont care
```REDIS_PORT=6379//dont care
```JWT_SECRET
```MAILGUN_API_KEY //dont care
```MAILGUN_API_DOMAIN ////dont care
